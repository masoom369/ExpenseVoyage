    ...
    <div class="container py-4">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                ...
                <p class="text-center">ExpenseVoyage: Simplifying Travel Expense Management for Everyone. Join us on
                    your next journey and keep your finances in check!</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container align-items-center">
        <div class="col-md-6 text-center text-md-end mb-md-0">
            <i class="fas fa-copyright me-2"></i><a class="text-white text-center" href="#">© 2024
                ExpenseVoyage</a>, All rights reserved.
        </div>
    </div>
</div>

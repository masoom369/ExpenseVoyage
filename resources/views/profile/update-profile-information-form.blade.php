    ...
    <div class="card-body">
        <form wire:submit.prevent="updateProfileInformation">
            ...
            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                <div x-data="{photoName: null, photoPreview: null}" class="mb-3">
                    ...
                    <div class="mt-2" x-show="!photoPreview">
                        <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="rounded-circle h-100 w-100" style="max-width: 100px; max-height: 100px;">
                    </div>

                    <!-- New Profile Photo Preview -->
                    <div class="mt-2" x-show="photoPreview" style="display: none;">
                        <span class="d-block rounded-circle w-100 h-100" style="max-width: 100px; max-height: 100px; background-size: cover; background-position: center;"
                              x-bind:style="'background-image: url(\'' + photoPreview + '\');'">
                        </span>
                    </div>

                    <button type="button" class="btn btn-primary mt-2 me-2" x-on:click.prevent="$refs.photo.click()">
            ...
            <div class="mb-3">
                ...
                @error('currency') <span class="text-danger mt-2">{{ $message }}</span> @enderror
            </div>

        ...
        <div class="card-body">
            ...
            <form action="{{ route('trips.update', $trip->id) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ $trip->name }}" required placeholder="Enter Trip Name">
                </div>

                <div class="form-group mb-3">
                    <label for="budget">Budget:</label>
                    <input type="number" name="budget" id="budget" class="form-control" value="{{ $trip->budget }}" required placeholder="Enter Budget">
                </div>
